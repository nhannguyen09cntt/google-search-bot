...
class GoogleSeach:
    ...
    def query_click(self, query, domain="4rum.vn"):
        ...
        try:
            ...
            answer_link = search_result.find_elements_by_xpath(
                "//*[contains(text(), '4rum.vn')]")[0]
            answer_link.click()
            time.sleep(2.4)
            link_document = self.driver.find_elements_by_xpath(
                "//*[contains(text(), '[Ebook] Tài liệu lập trình C/C++')]")[0]
            link_document.click()
            time.sleep(3)
            link_document = self.driver.find_elements_by_xpath(
                "//*[contains(text(), 'Giáo trình Nhập môn lập trình (PDF) – ĐH KHTN')]")[0]
            link_document.click()
            time.sleep(6)
            return 1
        except:
